...
'''
python main_eval.py   --common.config-file config/segmentation/ade20k/deeplabv3_mobilevitv2_1.0.yaml  --common.results-loc segment_result   --evaluation.segmentation.resize-input-images
python main_eval.py   --common.config-file config/segmentation/ade20k/deeplabv3_gpe_eval.yaml  --common.results-loc segment_result   --evaluation.segmentation.resize-input-images
python main_eval.py   --common.config-file config/segmentation/ade20k/deeplabv3_gpe.yaml  --common.results-loc segment_result   --evaluation.segmentation.resize-input-images
'''